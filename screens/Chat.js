  ...
  const handleSend = () => {
    if (inputText.trim()) {
      const messageData = {
        ...
        isUser: true,
        avatar: avatarImage,
        userId: userLogin.uid, // Ensure userId is not null
        username: userLogin.fullname, // Ensure username is not null
        timestamp: new Date().toISOString(), // Add timestamp
      };

      socket.emit('send_message', messageData); // Send data via socket
