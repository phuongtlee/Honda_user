...
const styles = StyleSheet.create({
  ...
  item: {
    borderWidth: 1,
    borderColor: '#1e90ff', // Đường viền màu chủ đạo
    padding: 15,
    marginVertical: 10,
    borderRadius: 10,
    backgroundColor: '#ffffff', // Màu nền cho từng mục
    flexDirection: 'row',
    ...
    shadowOpacity: 0.2,
    shadowRadius: 4,
    elevation: 3, // Tạo độ nổi cho mục
  },
  infoContainer: {
    flex: 1,
  },
  carInfo: {
    fontSize: 18,
    fontWeight: 'bold',
    color: '#333', // Màu chữ cho thông tin xe
  },
  userInfo: {
    fontSize: 16,
    color: '#555', // Màu chữ cho thông tin người dùng
  },
  dateInfo: {
    fontSize: 14,
    color: '#777', // Màu chữ cho thông tin ngày
  },
  timeInfo: {
    fontSize: 14,
    color: '#777', // Màu chữ cho thông tin giờ
  },
  statusInfo: {
    fontSize: 16,
    fontWeight: 'bold',
  ...
  noDataText: {
    fontSize: 16,
    textAlign: 'center',
    color: '#999', // Màu chữ cho thông báo không có dữ liệu
  },
});
